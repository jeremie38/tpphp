...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_6c9477cb84c6bd0ed1ac9db8c479698a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6c9477cb84c6bd0ed1ac9db8c479698a');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_6c9477cb84c6bd0ed1ac9db8c479698a');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\home\\loginBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\home\\adminBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\home\\AccueilBundle\\Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'home\\loginBundle\\Entity');
        $f->addDriver($e, 'home\\adminBundle\\Entity');
        $f->addDriver($e, 'home\\AccueilBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('loginBundle' => 'home\\loginBundle\\Entity', 'adminBundle' => 'home\\adminBundle\\Entity', 'AccueilBundle' => 'home\\AccueilBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\home\\loginBundle/Resources/views'), 'login');
        $instance->addPath(($this->targetDirs[3].'\\src\\home\\adminBundle/Resources/views'), 'admin');
        $instance->addPath(($this->targetDirs[3].'\\src\\home\\AccueilBundle/Resources/views'), 'Accueil');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'loginBundle' => 'home\\loginBundle\\loginBundle',
                'adminBundle' => 'home\\adminBundle\\adminBundle',
                'AccueilBundle' => 'home\\AccueilBundle\\AccueilBundle',
